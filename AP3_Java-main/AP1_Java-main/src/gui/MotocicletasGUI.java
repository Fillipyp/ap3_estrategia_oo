 ...
 */
public final class MotocicletasGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CADASTRO DE MOTOCICLETAS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MotocicletasGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new MotocicletasGUI().setVisible(true);
        });
    }
